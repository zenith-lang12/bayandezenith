...
{{
  ...
  "harus_diubah": "String teks hal-hal yang harus diperbaiki, dipisah koma (BUKAN array/list JSON, kalau REJECTED)"
}}
"""
    ...
    async def pipe(
        ...
        for attempt in range(max_retry + 1):
            ...
            if "APPROVED" in v:
                ...
                # (salah interpret kata "List" di prompt → crash .lower())
